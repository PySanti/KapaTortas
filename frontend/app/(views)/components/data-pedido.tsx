...
export default function DataPedido({ perfilDir, order, deliveryPriceHandler, total }: { perfilDir: DireccionEnvio | undefined, order: ItemFormat[], deliveryPriceHandler: (item: number) => void, total: number }) {
    ...
    const defaultValues = {
        ...
        codigo_postal: typeof perfilDir?.codigo_postal === "string" 
        ? parseInt(perfilDir.codigo_postal, 10) || 1000 
        : perfilDir?.codigo_postal || 1000,
    }
          ...
          <div className="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
            ...
            <div className="mt-6 grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-3">
                <div className="sm:col-span-3">
                  <label htmlFor="address" className="block text-sm font-medium text-terciary">
                    Dirección
                  </label>
                  <div className="mt-1">
